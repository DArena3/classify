  ...
  return (
    <div>
      <nav className="flex justify-between items-center mb-6">
        ...
        <h2 className="text-lg font-semibold p-4"><span className="text-xl font-bold text-red-800">Classify</span>: Classical Music Catalog for the WHRB (Harvard Radio) collection of CDs and LPs</h2>
        <div>
